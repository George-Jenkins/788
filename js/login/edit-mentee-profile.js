...
//in school checkbox
$('#in-school-yes').click(function(){
	$(this).addClass('button2-clicked')
	$('#in-school-no').removeClass('button2-clicked')
	$('#school-div').removeClass('hide')
})
$('#in-school-no').click(function(){
	$(this).addClass('button2-clicked')
	$('#in-school-yes').removeClass('button2-clicked')
	$('#school-div').addClass('hide')
	$('#school-input').val('').addClass('hide')
	$('#school').html('')
	var z = getZ()
	var input = 'no school';
	var field = 'school';
...
$('#done-edit-school').click(function(){
	var z = getZ()
	var input = $('#school-input').val()
	var field = 'school';
	var path = getPostPath('http://witzkey.com/login/')
	$.post(path+'queries/edit-profile.php',{z:z, input:input, field:field},function(data){
...
$('#cancel-edit-school').click(function(){
	cancelEdit('school')
})//click
